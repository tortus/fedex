module Fedex
	...
	module ShipConstants
		# {http://fedex.com/ws/ship/v9}AdditionalLabelsType
		class AdditionalLabelsTypes < ::String
		  ...
		  FREIGHT_REFERENCE = AdditionalLabelsTypes.new("FREIGHT_REFERENCE")
		...
		# {http://fedex.com/ws/ship/v9}B13AFilingOptionType
		...
		# {http://fedex.com/ws/ship/v9}BarcodeSymbologyType
		...
		# {http://fedex.com/ws/ship/v9}BinaryBarcodeType
		class BinaryBarcodeTypes < ::String
		  COMMON_2D = BinaryBarcodeTypes.new("COMMON_2D")
		end
		
		# {http://fedex.com/ws/ship/v9}CarrierCodeType
		...
		# {http://fedex.com/ws/ship/v9}ClearanceBrokerageType
		...
		# {http://fedex.com/ws/ship/v9}CodAddTransportationChargesType
		...
		# {http://fedex.com/ws/ship/v9}CodCollectionType
		class CodCollectionTypes < ::String
		  ANY = CodCollectionTypes.new("ANY")
		  CASH = CodCollectionTypes.new("CASH")
		  COMPANY_CHECK = CodCollectionTypes.new("COMPANY_CHECK")
		  GUARANTEED_FUNDS = CodCollectionTypes.new("GUARANTEED_FUNDS")
		  PERSONAL_CHECK = CodCollectionTypes.new("PERSONAL_CHECK")
		end
		
		# {http://fedex.com/ws/ship/v9}CodReturnReferenceIndicatorType
		...
		# {http://fedex.com/ws/ship/v9}CustomDeliveryWindowType
		...
		# {http://fedex.com/ws/ship/v9}CustomLabelCoordinateUnits
		...
		# {http://fedex.com/ws/ship/v9}CustomerImageUsageType
		...
		# {http://fedex.com/ws/ship/v9}CustomerReferenceType
		...
		# {http://fedex.com/ws/ship/v9}DangerousGoodsAccessibilityType
		...
		# {http://fedex.com/ws/ship/v9}DayOfWeekType
		...
		# {http://fedex.com/ws/ship/v9}DeletionControlType
		...
		# {http://fedex.com/ws/ship/v9}DestinationControlStatementType
		...
		# {http://fedex.com/ws/ship/v9}DocTabContentType
		...
		# {http://fedex.com/ws/ship/v9}DocTabZoneJustificationType
		...
		# {http://fedex.com/ws/ship/v9}DropoffType
		...
		# {http://fedex.com/ws/ship/v9}EMailNotificationAggregationType
		class EMailNotificationAggregationTypes < ::String
		  PER_PACKAGE = EMailNotificationAggregationTypes.new("PER_PACKAGE")
		  PER_SHIPMENT = EMailNotificationAggregationTypes.new("PER_SHIPMENT")
		end
		
		# {http://fedex.com/ws/ship/v9}EMailNotificationFormatType
		...
		# {http://fedex.com/ws/ship/v9}EMailNotificationRecipientType
		class EMailNotificationRecipientTypes < ::String
		  ...
		  THIRD_PARTY = EMailNotificationRecipientTypes.new("THIRD_PARTY")
		end
		
		# {http://fedex.com/ws/ship/v9}EdtRequestType
		class EdtRequestTypes < ::String
		  ALL = EdtRequestTypes.new("ALL")
		  NONE = EdtRequestTypes.new("NONE")
		end
		
		# {http://fedex.com/ws/ship/v9}EdtTaxType
		...
		# {http://fedex.com/ws/ship/v9}ErrorLabelBehaviorType
		...
		# {http://fedex.com/ws/ship/v9}FedExLocationType
		...
		# {http://fedex.com/ws/ship/v9}FreightAccountPaymentType
		...
		# {http://fedex.com/ws/ship/v9}FreightChargeBasisType
		...
		# {http://fedex.com/ws/ship/v9}FreightClassType
		...
		# {http://fedex.com/ws/ship/v9}FreightCollectTermsType
		class FreightCollectTermsTypes < ::String
		  SECTION_7_SIGNED = FreightCollectTermsTypes.new("SECTION_7_SIGNED")
		  STANDARD = FreightCollectTermsTypes.new("STANDARD")
		end
		
		# {http://fedex.com/ws/ship/v9}FreightOnValueType
		...
		# {http://fedex.com/ws/ship/v9}FreightShipmentRoleType
		...
		# {http://fedex.com/ws/ship/v9}HazardousCommodityLabelTextOptionType
		...
		# {http://fedex.com/ws/ship/v9}HazardousCommodityOptionType
		...
		# {http://fedex.com/ws/ship/v9}HazardousCommodityPackingGroupType
		...
		# {http://fedex.com/ws/ship/v9}HomeDeliveryPremiumType
		...
		# {http://fedex.com/ws/ship/v9}ImageId
		...
		# {http://fedex.com/ws/ship/v9}InternationalDocumentContentType
		...
		# {http://fedex.com/ws/ship/v9}LabelFormatType
		class LabelFormatTypes < ::String
		  COMMON2D = LabelFormatTypes.new("COMMON2D")
		  FEDEX_FREIGHT_STRAIGHT_BILL_OF_LADING = LabelFormatTypes.new("FEDEX_FREIGHT_STRAIGHT_BILL_OF_LADING")
		  LABEL_DATA_ONLY = LabelFormatTypes.new("LABEL_DATA_ONLY")
		  VICS_BILL_OF_LADING = LabelFormatTypes.new("VICS_BILL_OF_LADING")
		end
		
		# {http://fedex.com/ws/ship/v9}LabelMaskableDataType
		...
		# {http://fedex.com/ws/ship/v9}LabelPrintingOrientationType
		...
		# {http://fedex.com/ws/ship/v9}LabelRotationType
		...
		# {http://fedex.com/ws/ship/v9}LabelStockType
		class LabelStockTypes < ::String
		  ...
		  PAPER_LETTER = LabelStockTypes.new("PAPER_LETTER")
		...
		# {http://fedex.com/ws/ship/v9}LiabilityCoverageType
		...
		# {http://fedex.com/ws/ship/v9}LinearUnits
		class LinearUnits < ::String
		  CM = LinearUnits.new("CM")
		  IN = LinearUnits.new("IN")
		end
		
		# {http://fedex.com/ws/ship/v9}MinimumChargeType
		...
		# {http://fedex.com/ws/ship/v9}NaftaImporterSpecificationType
		...
		# {http://fedex.com/ws/ship/v9}NaftaNetCostMethodCode
		class NaftaNetCostMethodCode < ::String
		  NC = NaftaNetCostMethodCode.new("NC")
		  NO = NaftaNetCostMethodCode.new("NO")
		end
		
		# {http://fedex.com/ws/ship/v9}NaftaPreferenceCriterionCode
		...
		# {http://fedex.com/ws/ship/v9}NaftaProducerDeterminationCode
		...
		# {http://fedex.com/ws/ship/v9}NaftaProducerSpecificationType
		...
		# {http://fedex.com/ws/ship/v9}NotificationSeverityType
		...
		# {http://fedex.com/ws/ship/v9}OversizeClassType
		...
		# {http://fedex.com/ws/ship/v9}PackageSpecialServiceType
		...
		# {http://fedex.com/ws/ship/v9}PackagingType
		...
		# {http://fedex.com/ws/ship/v9}PaymentType
		...
		# {http://fedex.com/ws/ship/v9}PendingShipmentType
		class PendingShipmentTypes < ::String
		  EMAIL = PendingShipmentTypes.new("EMAIL")
		end
		
		# {http://fedex.com/ws/ship/v9}PhysicalPackagingType
		...
		# {http://fedex.com/ws/ship/v9}PickupRequestSourceType
		...
		# {http://fedex.com/ws/ship/v9}PrintedReferenceType
		class PrintedReferenceTypes < ::String
		  CONSIGNEE_ID_NUMBER = PrintedReferenceTypes.new("CONSIGNEE_ID_NUMBER")
		  SHIPPER_ID_NUMBER = PrintedReferenceTypes.new("SHIPPER_ID_NUMBER")
		end
		
		# {http://fedex.com/ws/ship/v9}PurposeOfShipmentType
		...
		# {http://fedex.com/ws/ship/v9}RateDimensionalDivisorType
		...
		# {http://fedex.com/ws/ship/v9}RateDiscountType
		class RateDiscountTypes < ::String
		  ...
		  INCENTIVE = RateDiscountTypes.new("INCENTIVE")
		  OTHER = RateDiscountTypes.new("OTHER")
		  VOLUME = RateDiscountTypes.new("VOLUME")
		end
		
		# {http://fedex.com/ws/ship/v9}RateRequestType
		class RateRequestTypes < ::String
		  ACCOUNT = RateRequestTypes.new("ACCOUNT")
		  LIST = RateRequestTypes.new("LIST")
		  PREFERRED = RateRequestTypes.new("PREFERRED")
		end
		
		# {http://fedex.com/ws/ship/v9}RatedWeightMethod
		...
		# {http://fedex.com/ws/ship/v9}RebateType
		...
		# {http://fedex.com/ws/ship/v9}RecipientCustomsIdType
		...
		# {http://fedex.com/ws/ship/v9}RegulatoryControlType
		...
		# {http://fedex.com/ws/ship/v9}RequestedPackageDetailType
		...
		# {http://fedex.com/ws/ship/v9}RequestedShippingDocumentType
		class RequestedShippingDocumentTypes < ::String
		  ...
		  FREIGHT_ADDRESS_LABEL = RequestedShippingDocumentTypes.new("FREIGHT_ADDRESS_LABEL")
		...
		# {http://fedex.com/ws/ship/v9}ReturnEMailAllowedSpecialServiceType
		...
		# {http://fedex.com/ws/ship/v9}ReturnType
		...
		# {http://fedex.com/ws/ship/v9}ReturnedRateType
		class ReturnedRateTypes < ::String
		  INCENTIVE = ReturnedRateTypes.new("INCENTIVE")
		...
		# {http://fedex.com/ws/ship/v9}ReturnedShippingDocumentType
		class ReturnedShippingDocumentTypes < ::String
		  ...
		  FREIGHT_ADDRESS_LABEL = ReturnedShippingDocumentTypes.new("FREIGHT_ADDRESS_LABEL")
		  ...
		  RECIPIENT_ADDRESS_BARCODE = ReturnedShippingDocumentTypes.new("RECIPIENT_ADDRESS_BARCODE")
		  RECIPIENT_POSTAL_BARCODE = ReturnedShippingDocumentTypes.new("RECIPIENT_POSTAL_BARCODE")
		...
		# {http://fedex.com/ws/ship/v9}ServiceType
		...
		# {http://fedex.com/ws/ship/v9}ShipmentSpecialServiceType
		...
		# {http://fedex.com/ws/ship/v9}ShippingDocumentDispositionType
		...
		# {http://fedex.com/ws/ship/v9}ShippingDocumentEMailGroupingType
		...
		# {http://fedex.com/ws/ship/v9}ShippingDocumentGroupingType
		...
		# {http://fedex.com/ws/ship/v9}ShippingDocumentImageType
		...
		# {http://fedex.com/ws/ship/v9}ShippingDocumentStockType
		...
		# {http://fedex.com/ws/ship/v9}SignatureOptionType
		...
		# {http://fedex.com/ws/ship/v9}SmartPostAncillaryEndorsementType
		...
		# {http://fedex.com/ws/ship/v9}SmartPostIndiciaType
		...
		# {http://fedex.com/ws/ship/v9}SpecialRatingAppliedType
		...
		# {http://fedex.com/ws/ship/v9}TaxType
		...
		# {http://fedex.com/ws/ship/v9}TermsOfSaleType
		...
		# {http://fedex.com/ws/ship/v9}TinType
		...
		# {http://fedex.com/ws/ship/v9}UploadDocumentIdProducer
		...
		# {http://fedex.com/ws/ship/v9}UploadDocumentProducerType
		...
		# {http://fedex.com/ws/ship/v9}UploadDocumentType
		...
		# {http://fedex.com/ws/ship/v9}VariableHandlingChargeType
